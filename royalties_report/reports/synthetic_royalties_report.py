...
class RoyaltiesReportSynthetic(models.AbstractModel):
    _name = 'report.royalties_report.synthetic_royalties_report'
    ...
    def render_html(self, docids, data=None):
        ...
        return report_obj.render(
            'royalties_report.synthetic_royalties_report', docargs)
