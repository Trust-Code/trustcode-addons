    ...
    def _amount_all(self):
        ...
        for order in self:
            ...
            order.update({
                ...
                'amount_discount': order.pricelist_id.currency_id.round(
                    amount_discount),
...
class AccountTax(models.Model):
    ...
    def compute_all(self, price_unit, currency=None, quantity=1.0,
        ...
        for tax in self.sorted(key=lambda r: r.sequence):
            ...
            taxes.append({
                'id': tax.id,
                'name': tax.with_context(**{'lang': partner.lang} if partner
                                         else {}).name,
                'amount': tax_amount,
...
class SaleOrderLine(models.Model):
    ...
    discount = fields.Float(string='Desconto', digits=(16, 20),
                            default=0.0)
